...
const Navbar = () => {
  ...
  return (
    ...
    className='w-[31rem] h-[3rem] transition-all relative flex flex-row justify-center items-center md:w-[99vw]'
    >
    {
        data?.map((link)=>{
            return(
    ...
    <button className={`swiper-button-prev bg-gradient-to-r from-black/50 to-transparent w-10 h-full py-1 absolute left-0 flex flex-row justify-center items-center rounded-br-lg rounded-tr-lg`}>
    ...
    <button className={`swiper-button-next bg-gradient-to-l from-black/50 to-transparent w-10 h-full py-1 absolute right-0 flex flex-row justify-center items-center rounded-bl-lg rounded-tl-lg`}>
