...
const Navbar = () => {
  ...
  return (
    <>
    <div className='w-[31rem] h-[3rem] relative'>
    <Swiper
    slidesPerView={6}
    spaceBetween={10}
    freeMode={true}
    ...
    <button className={`swiper-button-prev bg-gradient-to-r from-black/50 to-transparent w-10 h-full py-1 absolute top-0 z-10 left-0 flex flex-row justify-center items-center rounded-lg`}>
    ...
    <button className={`swiper-button-next bg-gradient-to-l from-black/50 to-transparent w-10 h-full py-1 absolute top-0 z-10 right-0 flex flex-row justify-center items-center rounded-lg`}>
